...
int main( int argc, char* argv[] )
{
    ...
    cell_t *local_cur = (cell_t*)malloc(local_ext_width * sizeof(cell_t)); assert(local_cur != NULL);
    cell_t *local_next = (cell_t*)malloc(local_ext_width * sizeof(cell_t)); assert(local_next != NULL);
